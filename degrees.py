...
def load_data(directory):
    ...
    """
    # Load people
    with open(f"D:\languages\degrees\small/people.csv", encoding="utf-8") as f:
    ...
    # Load movies
    with open(f"D:\languages\degrees\small/movies.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            movies[row["id"]] = {
                "title": row["title"],
    ...
    # Load stars
    with open(f"D:\languages\degrees\small/stars.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            try:
...
def shortest_path(source, target):
    ...
    # Initialize a frontier using a queue data structure
